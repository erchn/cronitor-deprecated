...
#
#     from cronitor import metadata
#
# However, when we do this, we also import `cronitor/__init__.py'. If this
...
setup_dict = dict(
    ...
    entry_points={
        'console_scripts': [
            'cronitor_cli = cronitor.main:entry_point'
        ],
        # if you have a gui, use this
        # 'gui_scripts': [
        #     'cronitor_gui = cronitor.gui:entry_point'
        # ]
    }
)
